...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Stocking.price'
        db.alter_column(u'poptrack_stocking', 'price', self.gf('django.db.models.fields.FloatField')())

    def backwards(self, orm):

        # Changing field 'Stocking.price'
        db.alter_column(u'poptrack_stocking', 'price', self.gf('django.db.models.fields.IntegerField')())
