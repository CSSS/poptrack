...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Column'
        db.create_table(u'poptrack_column', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=32)),
        ))
        db.send_create_signal(u'poptrack', ['Column'])

        # Adding model 'Pop'
        db.create_table(u'poptrack_pop', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=32)),
        ))
        db.send_create_signal(u'poptrack', ['Pop'])

        # Adding model 'Filling'
        db.create_table(u'poptrack_filling', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('pop', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['poptrack.Pop'])),
            ('column', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['poptrack.Column'])),
        ...
        db.send_create_signal(u'poptrack', ['Filling'])


    def backwards(self, orm):
        # Deleting model 'Column'
        db.delete_table(u'poptrack_column')

        # Deleting model 'Pop'
        db.delete_table(u'poptrack_pop')

        # Deleting model 'Filling'
        db.delete_table(u'poptrack_filling')
