...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Column.price'
        db.alter_column(u'poptrack_column', 'price', self.gf('django.db.models.fields.FloatField')())

    def backwards(self, orm):

        # Changing field 'Column.price'
        db.alter_column(u'poptrack_column', 'price', self.gf('django.db.models.fields.IntegerField')())
