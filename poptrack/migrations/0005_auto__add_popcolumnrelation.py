...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PopColumnRelation'
        db.create_table(u'poptrack_popcolumnrelation', (
        ...
        db.send_create_signal(u'poptrack', ['PopColumnRelation'])


    def backwards(self, orm):
        # Deleting model 'PopColumnRelation'
        db.delete_table(u'poptrack_popcolumnrelation')
    ...
    models = {
        ...
        u'poptrack.popcolumnrelation': {
            'Meta': {'object_name': 'PopColumnRelation'},
            'column': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['poptrack.Column']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pop': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['poptrack.Pop']"})
        },
